...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                <div class="h3 text-center mb-4 mt-5">Login Admin</div>
                <div class="card">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            <li class="nav-item">
                                <a class="nav-link" style="color: grey;" href="index.php">Operator</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="card-body">
                        <form action="admin.php" method="POST">
                            ...
                            <button type="submit" name="login" class="btn btn-dark btn-block mt-4" style="letter-spacing: 1.5px;">LOGIN</button>
                        </form>
                    </div>
                </div>
            </div>
